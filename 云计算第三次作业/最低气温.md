...
将Java代码编译并打成jar包并上传需要统计的文件

```
export HADOOP_CLASSPATH=$(hadoop classpath)
mkdir min
javac -classpath ${HADOOP_CLASSPATH} -d min MintemputerGet.java
jar -cvf MintemputerGet.jar -C min/ .
hadoop fs -mkdir /min
hadoop fs -put /home/CRND0103-2021-AK_Utqiagvik_formerly_Barrow_4_ENE.txt /min/input

```

![guocheng](images/guocheng.png)

运行jar包

```
hadoop jar MintemputerGet.jar MintemputerGet /min/CRND0103-2021-AK_Utqiagvik_formerly_Barrow_4_ENE.txt /min/output
```

![image-20221114193032561](images/image-20221114193032561.png)

下载查看结果

```
hadoop fs -get /min/output/part-r-00000 .
```

![image-20221114193234476](images/image-20221114193234476.png)